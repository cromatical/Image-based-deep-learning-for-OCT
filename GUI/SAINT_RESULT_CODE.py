...
model = keras.models.load_model('C:/Users/croma/PycharmProjects/GUI/DenseNet121_allfine_5')#DenseNet121_allfine_5
# path='입력이미지 경로 '
# make_name='./생성할이미지'
...
def get_heat_map(heatmap,path,make_path):
    ...
    cv2.imwrite('C:/Users/croma/Desktop/heatmap/{}'.format(make_path), Finist)
    return "C:/Users/croma/Desktop/heatmap/{}"+make_path
