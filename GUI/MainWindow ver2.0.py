...
# Form implementation generated from reading ui file 'C:\Temp\MainWindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_3.clicked.connect(self.btn_function3)
    ...
    def show_img(self, signal):
        ...
        self.file_name = self.treeView.model().fileName(signal)
    ...
    def save_csv(self):
        ...
        if os.path.exists(path + csv_file_name):
            with open(path + csv_file_name, 'a', encoding='utf-8', newline="") as f:
                wr = csv.writer(f)
                wr.writerow([self.file_path])
        else:
            with open(path + csv_file_name, 'wt', encoding='utf-8', newline="") as f:
                wr = csv.writer(f)
                wr.writerow(row)
                wr.writerow([self.file_path])
    ...
    # load model function
    def btn_function3(self):
        fname = QtWidgets.QFileDialog.getOpenFileName()
        if fname[0]:
            self.model_path = fname[0]
            self.model = G.load_model(self.model_path)
