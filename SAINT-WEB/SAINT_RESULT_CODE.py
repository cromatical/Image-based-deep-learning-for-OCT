...
set_session(sess)
# model = keras.models.load_model('C:/Users/user/PycharmProjects/donghwi/donghwikim/DenseNet121_allfine_5')#DenseNet121_allfine_5
# path='D:/OCT/Crop_OCT/AMD/AMD-4.bmp'
# make_name='./YH.jpg'
...
#     히트맵 , % , 결과       = Heatmap(불러올 모델 , 입력이미지 경로 )
    # heatmap,prediction=Heatmap(model, path)
